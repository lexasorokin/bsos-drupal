 ...
 *   source_module = "migrate_custombsos",
 * )
 */
class FieldCollection extends FieldableEntity {
  ...
  public function prepareRow(Row $row) {
    ...
    // Guarantee nid key in source profile_id field.
    $gsprofile =  $row->getSourceProperty('field_grad_profile');
    $gsprofile = reset($gsprofile);
    $row->setSourceProperty('profile_id', [['nid' => $gsprofile['target_id']]]);
